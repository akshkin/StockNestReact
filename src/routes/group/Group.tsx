  ...
  return (
    <>
        ...
        <Modal
          ...
          children={
            <GroupCategoryAddEditForm
              ...
              onCreate={(args) => createCategory(args).unwrap()}
              onUpdate={(args) => updateCategory(args).unwrap()}
              closeModal={closeCategoryModal}
              mode={mode}
            />
          }
      ...
      {membersLoading || memberFetching ? (
        ...
        <ErrorText
          error={
            normalizeApiError(memberError).message ||
            "An error occurred while fetching the group members."
          }
        />
      ) : (
